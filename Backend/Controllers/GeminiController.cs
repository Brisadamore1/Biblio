                    ...
                    response_schema = new
                    {
                        ...
                        properties = new Dictionary<string, object>
                        {
                            ...
                            ["Generos"] = new
                            {
                                ...
                                items = new { type = "string" },
                                nullable = true,
                                description = "Géneros literarios aplicables al libro (ej: Ficción, No Ficción, Ciencia Ficción, Fantasía, Romance, Misterio, Biografía, Historia, Autoayuda)"
                            },
                            ["Editorial"] = new
                            {
                                type = "string",
